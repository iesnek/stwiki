...
<header id="header" class="l-header">
  <div class="l-headBar headBar asanoha">
    <div class="headBar_wrap clearfix">
  ...
  <div class="head_cvr asanoha"><div><img src="<?php echo get_template_directory_uri(); ?>/assets/img/mainv_sp.jpg" alt="戦国の虎z"></div></div>
...
<div class="l-block search mm-search">
  <?php get_search_form(); ?>
</div>

<?php if ( function_exists( 'is_multi_device' ) ): //スマホでもタブレットでも無い場合
  if ( !is_multi_device('smart') && !is_multi_device('tablet') ): ?>
<aside class="pr"></aside><!-- .pr -->
<?php endif; endif; ?>
...
<nav class="subNav_wrap">
  ...
  <ul class="subNav">
    ...
    <li class="subNav_fuda">
      <a class="subNav_parent" h subNav_ref=""><svg><title>陰陽札</title><use xlink:href="#fuda"/></svg>すべての陰陽札</a>
      <ul>
        <li><a href="">武士</a></li>
        <li><a href="">槍使い</a></li>
        <li><a href="">狙撃手</a></li>
    ...
    <li class="subNav_make">
      <a class="subNav_parent" h subNav_ref=""><svg><title>キャラメイク</title><use xlink:href="#make"/></svg>すべてのキャラメイク</a>
      <ul>
        <li><a href="">髪型</a></li>
        <li><a href="">目</a></li>
        <li><a href="">口</a></li>
